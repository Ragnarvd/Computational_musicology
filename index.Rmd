...
february_dip <-
  ...
  theme_vapor() +                  # Use a simpler theme.
...
***
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/06MWWxWRuBtYxcJP71tN0q?utm_source=generator" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
***
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/7Es2gcDpA0ma6zEqgP6Wuc?utm_source=generator" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
```
*** 
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/6ZFbXIJkuI1dVNWvzJzown?utm_source=generator" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
Two different novelty functions; Energy and Timbre. Energy is the clearest as expected, Timbre is better than expected. More detailed analyze will follow. 

### What are the components of my study playlist?

```{r halloween}
halloween <- 
  get_playlist_audio_features('bnfcollection', '7ex5hFjCiAdaXy6FFoe2Vi') %>% 
  add_audio_analysis %>% 
  mutate(
    segments = 
...
The dendrogram and heatmap at right breaks my own study playlist down in .. .clusters, based on the glover distance.

I have prioritized learning for my exams before working on my portfolio this week, so a more detailed analyze will follow. I have also created a own custom theme, I'm still working on this as you can see haha. 
